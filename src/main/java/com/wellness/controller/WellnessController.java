...
public class WellnessController {
		    ...
		    public String handlepost(@ModelAttribute("handlepost") UserLogin userLogin, BindingResult bindingResult, ModelMap model) throws ParseException{    	
		    ...
		    public String getname(ModelMap model, @RequestParam("id") long id){    	
		    	
		    	try {
		    		UserLogin userdetail= wellnesService.getUserById(id);
		    		model.addAttribute("myname",  "Hi my name is " +wellnesService.getUserById(id).getFname()+ " "+ wellnesService.getUserById(id).getLname());
		    		model.addAttribute("attribs", userdetail);
